...
![展开气泡](./guide/screenshots/04-popup-bubble.png)
...
![采用修正](./guide/screenshots/05-popup-applied.png)

全部采用后，状态变为「全部已修正 ✓」：

![全部修正](./guide/screenshots/07-popup-all-fixed.png)
...
![页面高亮](./guide/screenshots/06-page-highlight.png)
